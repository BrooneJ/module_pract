...
class SearchRepoImplTest {
    ...
    @Test
    fun test_success_with_null_list() = runTest {
    ...
    @Test
    fun test_backend_response_fails_recipe_details() = runTest {
    ...
    @Test
    fun test_backend_will_throw_exception_recipe_details() = runTest {
